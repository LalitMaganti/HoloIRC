...
import app.holoirc.event.OnCurrentServerStatusChanged;
import app.holoirc.event.OnQueryEvent;
import app.holoirc.event.OnServiceConnectionStateChanged;
...
import app.holoirc.util.CrashUtils;
import app.holoirc.util.NotificationUtils;
import app.holoirc.util.UIUtils;
import app.holoirc.view.ProgrammableSlidingPaneLayout;
...
import static app.holoirc.misc.AppPreferences.getAppPreferences;
import static app.holoirc.misc.FragmentType.CHANNEL;
import static app.holoirc.misc.FragmentType.DCCCHAT;
import static app.holoirc.misc.FragmentType.DCCFILE;
import static app.holoirc.misc.FragmentType.SERVER;
import static app.holoirc.misc.FragmentType.USER;
import static app.holoirc.util.MiscUtils.getBus;
import static app.holoirc.util.MiscUtils.getStatusString;
import static app.holoirc.util.UIUtils.isAppFromRecentApps;
