...
import com.fusionx.holoirc.adapters.IRCPagerAdapter;
import com.fusionx.holoirc.fragments.IRCActionsFragment;
import com.fusionx.holoirc.fragments.UserListFragment;
...
import com.fusionx.holoirc.interfaces.CommonIRCListenerInterface;
import com.fusionx.holoirc.irc.ServerCommunicator;
import com.fusionx.holoirc.listeners.ActivityListener;
import com.fusionx.holoirc.misc.Utils;
import com.fusionx.holoirc.parser.MessageParser;
import com.fusionx.holoirc.service.IRCService;
import com.fusionx.holoirc.ui.ActionsSlidingMenu;
import com.fusionx.holoirc.ui.IRCViewPager;
import com.fusionx.holoirc.ui.UserListSlidingMenu;
...
public class IRCFragmentActivity extends AbstractPagerActivity
    ...
    @Override
    public void onUserWhois(String nick) {
        ServerCommunicator.sendUserWhois(getBot(), nick);
    }
