...
import com.fusionx.lightirc.misc.ChannelMessageParser;
...
public class IRCService extends Service {
	...
	private ChannelMessageParser mChannelMessageReceiver = new ChannelMessageParser();
	...
	public void connectToServer(String serverName) {
		...
		if (!bot.isStarted()) {
			...
			Intent intent2 = new Intent(this, IRCService.class);
			intent2.putExtra("stop", true);
			PendingIntent pIntent = PendingIntent.getActivity(this, 0, intent,
					0);
			PendingIntent pIntent2 = PendingIntent.getService(this, 0, intent2,
					0);
