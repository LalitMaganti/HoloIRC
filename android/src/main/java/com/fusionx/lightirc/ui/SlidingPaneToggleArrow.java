...
public class SlidingPaneToggleArrow implements SlidingPaneLayout.PanelSlideListener {
    ...
    public SlidingPaneToggleArrow(ActionBarActivity activity, SlidingPaneLayout paneLayout) {
        ...
        mSlider = new DrawerArrowDrawable(activity.getSupportActionBar().getThemedContext(), activity);
    }
    ...
    private static class DrawerArrowDrawable extends Drawable {
        ...
        // overlapping sections wont look different
        ...
        DrawerArrowDrawable(Context context, Activity activity) {
            mActivity = activity;
        ...
        public void draw(Canvas canvas) {
            ...
            final boolean isRtl = ViewCompat.getLayoutDirection(mActivity.getWindow().getDecorView())
